 ...
 *********************************************/
public class HashTableImp5 implements HashTable {
    ...
    * */
    ...
    public HashTableImp5(int numOfBuckets) {
    ...
    * */
    private int hashFunction(String key){
        ...
        for(int i=0;i<key.length();i++){
            ...
            hash=( hash*523 + key.charAt(i))% hashTable.length;//hash*31+key.charAt(i);//add ascii value of the characters
