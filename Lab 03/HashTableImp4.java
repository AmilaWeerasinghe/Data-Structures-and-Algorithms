 ...
 *********************************************/
public class HashTableImp4 implements HashTable {
    ...
    * */
    ...
    public HashTableImp4(int numOfBuckets) {
    ...
    * */
    private int hashFunction(String key){
        ...
        for(int i=0;i<key.length();i++){
            ...
            hash=( hash*71 + key.charAt(i)) % hashTable.length;//hash*31+key.charAt(i);//add ascii value of the characters
